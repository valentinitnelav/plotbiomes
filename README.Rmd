...
The original graph is Figure 5.5 in *Ricklefs, R. E. (2008), The economy of nature. W. H. Freeman and Company.* (Chapter 5, Biological Communities, The biome concept). The figure was processed and brought into an R friendly format. Details are given in *Whittaker_biomes_dataset.html* vignette. To access the vignette, after installation run `RShowDoc("Whittaker_biomes_dataset", package = "plotbiomes")`
...
After installation check the *Whittaker_biomes_examples.html* vignette by executing `RShowDoc("Whittaker_biomes_examples", package = "plotbiomes")`
